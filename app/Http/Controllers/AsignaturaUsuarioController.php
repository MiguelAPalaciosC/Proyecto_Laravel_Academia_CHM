...
class AsignaturaUsuarioAdminController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request) {
            ...
            // ->paginate(10);
            $asigus=DB::select('SELECT a.id_asignatura,a.codigo,a.nombre,u.name as id_usuario FROM asignatura as a JOIN users as u ON (a.id_usuario=u.id)');
            ...
            return view('academia.asignatura.index',["asigus"=>$asigus,"asignatura"=>$asignatura,"users"=>$users]);
        }
    }
    ...
    public function update(asignaturaFormRequest $request,$id){
        ...
        $asignatura->fill($request->all())->save();
